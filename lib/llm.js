...
For spice levels, ONLY set a specific level if the user explicitly mentions their preferred spice level. If they don't mention a spice level, return "Medium" as the default.
...
2. Only set a specific spice level if the user explicitly mentions their preferred spice level. Otherwise, use "Medium" as the default.
